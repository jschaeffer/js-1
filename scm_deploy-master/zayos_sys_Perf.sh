...
case $Comp in
  ...
  inar[6]=cv-pfdec-eng07.cv.perf:PF_DECENG_07:ads:ads
  inar[7]=cv-pfde_ciping01.cv.perf:PF_CIPING_01:ads:ads
  inar[8]=cv-pfde_ciping02.cv.perf:PF_CIPING_02:ads:ads
  inar[9]=cv-pfde_ciping03.cv.perf:PF_CIPING_03:ads-1.2.0:ads
  inar[10]=cv-pfde_ciping04.cv.perf:PF_CIPING_04:ads-1.2.0:ads
  inar[11]=cv-pfcluster01.cv.perf:PF_CIS_01:cis:cis
  inar[12]=cv-pfcluster01.cv.perf:PF_CIS_02:cis:cis
 ;;
 ...
 ;;
 request-mgr)
  inar[0]=cv-pfrqman01.cv.perf:PF_REQMAN_01:request-manager:request-manager:REQMAN:REQMAN:-DCAMPAIGN_SCHEMA_NAME=CAAS_CORE
 ...
 smsi-publisher)
  ...
  inar[4]=cv-pfsmsi-pub05.cv.perf:PF_SMSIPUB_05:smsi-pub:smsi-publisher
 ;;
 dai-smsi)
  ...
  inar[4]=cv-pfsmsi_ing01.cv.perf:PF_REMA_INGEST:smsi:safi-smsi-server
  inar[5]=cv-pfsmsi_ing02.cv.perf:PF_REMA_INGEST:smsi:safi-smsi-server
 ;;
 smsiCorrection)
  inar[0]=cv-pfcluster04.cv.perf:PF_SMSI_CORR:smsi_correction:smsi-correction-agent
 ;;
...
# ;;
 ADI-MDI)
  inar[0]=cv-pfcluster04.cv.perf:PF_ADI-MDI_01:ADI-MDI-Ingest:ADI-MDI-Ingest:ADI_MDI_01:ADI_MDI_01
 ;;
 dai-smsi-relay)
 ...
 dai-national-cis)
  ...
  inar[1]=cv-pfcluster01.cv.perf:PF_NCIS_02:nCisClient:nCisClient:NCIS2:NCIS2:-DCAAS_SCHEMA_NAME=CAAS_CORE
 ;;
 POIS)
