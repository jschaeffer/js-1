...
ssh cvbuild@cvbuild.cv.infra "bash -c \"source ~/.bash_profile && cd /opt/build/scm/scripts/buildServer/groovy/bin && ./createRelease.sh ${PROJECT_NAME} ${PROJECT_ROOT} ${LOD} ${BUILD_NUMBER} \" "
