...
ssh cvbuild@10.13.18.168 "bash -c \"source ~/.bash_profile && source ~/bin/gr2_0.sh && cd /opt/build/scm/scripts/buildServer/groovy/bin && ./createRelease.sh ${PROJECT_NAME} ${PROJECT_ROOT} ${LOD} \" "
