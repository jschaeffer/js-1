...
AGENT_PATHS=""
JAVA_AGENTS=""
JVM_OPTS="-Xss192K -Djava.awt.headless=true -Xms6G -Xmx6G -XX:MaxPermSize=256m -Dgemfire.disableShutdownHook=true"
export APPHOME_DIR=/opt/tcserver/instances/FW_SMSI_RELAY_02
