...
export APPHOME_DIR=/opt/tcserver/instances/ads0101_40
export CONFIG_DIR=$APPHOME_DIR/ads-config
export LOG4J_XML=$APPHOME_DIR/conf/log4j.xml

JAVA_OPTS="$JVM_OPTS $AGENT_PATHS $JAVA_AGENTS $JAVA_LIBRARY_PATH -Dconfig.dir=$CONFIG_DIR -Dlog4j.location=$LOG4J_XML -Dorg.apache.cxf.Logger=org.apache.cxf.common.logging.Log4jLogger"
