...
if ( !isset($_POST['brtype']) ) {
    echo '<div align="center">';
    echo '<form method="post" name="brType">';
    echo '<table class="details">';
    echo '<tr>';
    echo '<th colspan="2">Select a branch point type from Project</th>';
    echo '</tr>';
    echo '<tr>';
    ...
    echo '</tr>';
    echo '</table>';
    echo '<input type="submit" value="Select Branch Type"/>';
    echo '</form>';
    echo '</div>';
