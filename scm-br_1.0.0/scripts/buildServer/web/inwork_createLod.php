...
elseif ( !isset($_POST['lod']) ) {
    ...
    echo '<table class="details">';
    echo '<tr>';
    echo '<th colspan="2">Create Branch for Project ' . $_POST['project'] . '</th>';
    echo '</tr>';
    echo '<tr>';
    echo '<td>Source Branch to Create Branch From</td>';
    echo '<td>' . getLodDropDown($_POST['project'], 'lod', $multipleSelect) . '</td>';
    echo '</tr>';
    echo '<td>Branch Point to Create Branch From</td>';
