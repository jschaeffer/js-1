...
print "<td bgcolor=#CEFFFD align=left><input class=\"lnk\" id=\"lnk$inclnk\" type=\"button\" value=\"[+] Expand\" onclick=\"toggle_visibility('tbl$inclnk','lnk$inclnk');\"></td><td bgcolor=#CEFFFD align=left><strong>${dashtarg}</strong></td><td bgcolor=#CEFFFD align=left>$tab$tab$tab$tab$tab Data Current as of : $lastup $tab$tab$tab </td><td bgcolor=#CEFFFD align=right>Disk Space Left- $targdisk</td>\n";
print "</tr>\n";
  ...
  for ($x=0; $x<$arrlength; $x++) {
     ...
     $locver=str_replace("_",".","$locver1");
        if ($devver == $locver) {
             ...
             $updavail = "<a href=\"http://cvbuild.cv.infra:7001/job/${targ}_SingleComponent_Deploy/buildWithParameters?token=SCRUM&Component=${compforupdate}&Version=${cmdev}\"><input type=submit class=styled-button-4 value=\"Yes Update\" /></a> -to $cmdev";
        }
...
foreach ($post_envs as $targ) {
  ...
  $dashtarg=strtoupper($targ);
print "<table width=1100px border=0 align=center cellpadding=4 cellspacing=0>\n";
print "<td bgcolor=#B5FFFC align=left><input class=\"lnk\" id=\"lnk$inclnk\" type=\"button\" value=\"[+] Expand\" onclick=\"toggle_visibility('tbl$inclnk','lnk$inclnk');\"></td><td bgcolor=#B5FFFC align=left><strong>${dashtarg}</strong></td><td bgcolor=#B5FFFC align=left>$tab$tab$tab$tab$tab Data Current as of : $lastup $tab$tab$tab </td><td bgcolor=#B5FFFC align=right>Disk Space Left- $targdisk</td>\n";
print "</tr>\n";
...
foreach ($perf_envs as $targ) {
  ...
  $dashtarg=strtoupper($targ);
print "<table width=1100px border=0 align=center cellpadding=4 cellspacing=0>\n";
print "<td bgcolor=#B5FFFC align=left><input class=\"lnk\" id=\"lnk$inclnk\" type=\"button\" value=\"[+] Expand\" onclick=\"toggle_visibility('tbl$inclnk','lnk$inclnk');\"></td><td bgcolor=#B5FFFC align=left><strong>$tab&nbsp&nbsp ${dashtarg}</strong></td><td bgcolor=#B5FFFC align=right>Data Current as of : $lastup $tab$tab$tab$tab$tab$tab$tab$tab$tab$tab$tab$tab$tab$tab </td><td bgcolor=#B5FFFC align=right>$tab$tab$tab$tab$tab$tab$tab$tab$tab$tab</td>\n";
print "</tr>\n";

print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=#B5FFFC colspan=7 align=left>Operations --> $tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/performance-EnvRefresh/build?token=TOKEN_NAME\"><input type=submit class=styled-button-4 value=\"Refresh data\" /></a>$tab$tab<a href=\"../deployLogs/${targ}.html\"><input type=submit class=styled-button-4 value=\"Recent ${targ} Deployments\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/${targ}_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-4 value=\"Update a Component\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/${targ}_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-4 value=\"Restart a tcserver instance\" /></a>
</td></tr>\n";
...
foreach ($lab_envs as $targ) {
  ...
  $dashtarg=strtoupper($targ);
print "<table width=1100px border=0 align=center cellpadding=4 cellspacing=0>\n";
print "<td bgcolor=#B5FFFC align=left><input class=\"lnk\" id=\"lnk$inclnk\" type=\"button\" value=\"[+] Expand\" onclick=\"toggle_visibility('tbl$inclnk','lnk$inclnk');\"></td><td bgcolor=#B5FFFC align=left width=6%><strong>${dashtarg}</strong></td><td bgcolor=#B5FFFC align=left>$tab$tab$tab$tab$tab$tab Data Current as of : $lastup $tab$tab$tab </td><td bgcolor=#B5FFFC align=right>$tab$tab$tab$tab$tab$tab</td>\n";
print "</tr>\n";

print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=#CEFFFD colspan=7 align=left>Operations --> $tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/lab-to-labEnv-Refresh\"><input type=submit class=styled-button-4 value=\"Refresh Update Mgr. data\" /></a>$tab";
...
foreach ($cox_envs as $targ) {
  ...
  $dashtarg=strtoupper($targ);
print "<table width=1100px border=0 align=center cellpadding=4 cellspacing=0>\n";
print "<td bgcolor=#B5FFFC align=left width=14%><input class=\"lnk\" id=\"lnk$inclnk\" type=\"button\" value=\"[+] Expand\" onclick=\"toggle_visibility('tbl$inclnk','lnk$inclnk');\"></td><td bgcolor=#B5FFFC align=left width=15%><strong>${dashtarg}</strong></td><td bgcolor=#B5FFFC align=left>Data Current as of : $lastup  </td><td bgcolor=#B5FFFC align=right></td>\n";
print "</tr>\n";

print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=#CEFFFD colspan=10 align=left>Operations --> $tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/xxxEnv-Refresh\"><input type=submit class=styled-button-4 value=\"Refresh Update Mgr. data\" /></a>$tab";
print "<a href=\"../deployLogs/coxlab.html\"><input type=submit class=styled-button-4 value=\"Recent Cox Lab Deployments\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/cox_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-4 value=\"Update a Component\" /></a></td></tr>\n";
...
global $cmdev;
  ...
  for ($x=0; $x<$cox_arrlength; $x++) {
     ...
     print "<tr>";
     echo "<td>".$cox_components[$x][1]."</td><td>";
     include "${comp_dir}.txt";
...
print "<h3>Production Test Dashboard</h3>";
foreach ($prodtest_envs as $targ) {
  $inclnk++;
  $lastup=file_get_contents("prodtest/dtupd.txt", true);
  $dashtarg=strtoupper($targ);
print "<table width=1100px border=0 align=center cellpadding=4 cellspacing=0>\n";
print "<td bgcolor=#B5FFFC align=left width=14%><input class=\"lnk\" id=\"lnk$inclnk\" type=\"button\" value=\"[+] Expand\" onclick=
\"toggle_visibility('tbl$inclnk','lnk$inclnk');\"></td><td bgcolor=#B5FFFC align=left width=15%><strong>${dashtarg}</strong></td><td
 bgcolor=#B5FFFC align=left> Data Current as of : $lastup $tab$tab$tab </td><td bgcolor=#B5FFFC align=right></td>\n";
print "</tr>\n";

print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=
\"tbl\">\n";
...
print "<a href=\"../deployLogs/prodtest.html\"><input type=submit class=styled-button-4 value=\"Recent ProdTest Deployments\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/ProdTest_SingleComponentDeploy/build?delay=0sec\"><input type=submit class=styled-button-4 value=\"Update a Component\" /></a></td></tr>\n";
...
global $cmdev;
  ...
  for ($x=0; $x<$prodtest_arrlength; $x++) {
     $comp_dir="prodtest/".$prodtest_components[$x][0]."";
     print "<tr>";
     echo "<td>".$prodtest_components[$x][1]."</td><td>";
     include "${comp_dir}.txt";
     $instdate=file_get_contents("prodtest/".$prodtest_components[$x][0].".instdate.txt", true);
     $showinst="<td>$instdate";
     echo "$showinst";
     print "</td><td>";
     $rel_dir="releases/".$prodtest_components[$x][0]."_$cmloc";
     $recentchg = "<h2><a href=\"${rel_dir}.html\">See Version Info</a></h3>";
     echo "$recentchg";
     print "</td></tr>";
  }
...
foreach ($prod_envs as $targ) {
  ...
  $dashtarg=strtoupper($targ);
print "<table width=1100px border=0 align=center cellpadding=4 cellspacing=0>\n";
print "<td bgcolor=#B5FFFC align=left width=14%><input class=\"lnk\" id=\"lnk$inclnk\" type=\"button\" value=\"[+] Expand\" onclick=\"toggle_visibility('tbl$inclnk','lnk$inclnk');\"></td><td bgcolor=#B5FFFC align=left width=15%><strong>${dashtarg}</strong></td><td bgcolor=#B5FFFC align=left> Data Current as of : $lastup $tab$tab$tab </td><td bgcolor=#B5FFFC align=right></td>\n";
print "</tr>\n";

print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=#CEFFFD colspan=10 align=left>Operations --> $tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/xxxEnv-Refresh\"><input type=submit class=styled-button-4 value=\"(Will be) Refresh Update Mgr. data\" /></a>$tab";
print "<a href=\"../deployLogs/production.html\"><input type=submit class=styled-button-4 value=\"Recent Production Deployments\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/Production_SingleComponentDeploy/build?delay=0sec\"><input type=submit class=styled-button-4 value=\"Update a Component\" /></a></td></tr>\n";
