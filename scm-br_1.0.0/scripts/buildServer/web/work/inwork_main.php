...
print "<td bgcolor=#C0E0DA align=left><input class=\"lnk\" id=\"lnk$inclnk\" type=\"button\" value=\"[+] Expand\" onclick=\"toggle_visibility('tbl$inclnk','lnk$inclnk');\"><strong>$targ</strong></td><td bgcolor=#C0E0DA align=right>Disk Space Left- $targdisk</td>\n";
print "</tr>\n";
...
print "<tr><td bgcolor=#C0E0DA colspan=1 align=center>";
  if (isset($_GET['refresh_button']))
   {
      shell_exec('/var/www/html/bin/envRefreshdevint.sh');
   }
?>
<form method="get"><button name="refresh_button" value="refreshdata">Refresh Data</button>
<?php
print "</td><td bgcolor=#C0E0DA colspan=1 align=center><a href=\"../deployLogs/${targ}.html\"><input type=submit class=styled-button-4 value=\"Recent ${targ} Deployments\" /></a></td>
<td colspan=2 bgcolor=#C0E0DA align=center><a href=\"http://cvbuild.cv.infra:7001/job/${targ}_Multicomponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-4 value=\"Deploy Multiple Components at DevInt Version\" /></a></td>
<td colspan=2 bgcolor=#C0E0DA align=center><a href=\"http://cvbuild.cv.infra:7001/job/${targ}_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-4 value=\"Restart a tcserver instance\" /></a></td></tr>\n";
print "<tr bgcolor=#CCCCCC>\n";

print "<td width=25%><b><u>Component</b></u></td>\n";
print "<td width=15%><b><u>Current ${targ} Version</b></u></td>\n";
print "<td width=20%><b><u>Newer DevInt Version Avail?</b></u></td>\n";
  ...
  for ($x=0; $x<$arrlength; $x++) {
     ...
     $cmloc=file_get_contents("${comp_dir}.txt", true);
        if ($cmdev > $cmloc) {
             ...
             $updavail="<font color=white>at current";
             $recentchg="<font color=white>NA";
        }
     print "</td><td>";
     echo "$updavail";
     print "</td><td>";
...
print "<table width=1200px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=#C0E0DA colspan=2 align=center><a href=\"../deployLogs/${targ}.html\"><input type=submit class=styled-button-4 value=\"Recent ${targ} Deployments\" /></a></td>
<td colspan=2 bgcolor=#C0E0DA align=center>&nbsp</td>
<td colspan=2 bgcolor=#C0E0DA align=center><a href=\"http://cvbuild.cv.infra:7001/job/${targ}_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-4 value=\"Restart a tcserver instance\" /></a></td></tr>\n";
