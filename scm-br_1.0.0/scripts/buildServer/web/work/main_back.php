...
print "<a href=\"../deployLogs/production.html\"><input type=submit class=styled-button-4 value=\"(Will be) Recent Production Deployments\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/xxx_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-4 value=\"(Will be) Update a Component\" /></a></td></tr>\n";
