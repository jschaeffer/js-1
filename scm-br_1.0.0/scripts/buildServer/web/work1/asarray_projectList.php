...
$lab2lab_components = array
   ...
   array("dai-cip","$tab;CIP Sender","dai-cip-PackageDeploy-4.0.0","2","NA"),
   array("dai-cip-feedback","$tab;CIP Feedback","dai-cip-feedback-PackageDeploy-4.0.0","2","9300/cip-server"),
...
$grid_envs = array(devint, scrum1, scrum2, scrum3, scrum4, performance, base, fw, kodiak, coxlab, broadway, production);
$rcr_envs = array(base, fw, kodiak, coxlab, broadway);
$zayo_perf_envs = array(performance);
$lab_envs = array(base,fw,kodiak,coxlab,broadway);
