...
print "<td width=15%><b><u>Current ${dashtarg} Version</u><br>& Date Installed<br>& JDK Compiled</b></td>\n";
...
foreach ($lab_envs as $targ) {
  ...
  if ($targ == kodiak) {
   ...
   if ($pos === false) {
    $resetState="$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/L2LPreserveState/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Stop and preserve state\"/></a>";
        }
    else {
    $resetState="$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/L2LResurrectState/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Resurrect to preserved state\"/></a>";
        }
