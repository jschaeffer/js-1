...
print "<tr><td bgcolor=${back_col} colspan=7 align=left><a href=\"http://cvbuild.cv.infra:7001/job/SelectSCMEnv-Refresh/buildWithParameters?token=TOKEN_NAME&SelEnv=${targ}\"><input type=submit class=styled-button-2 value=\"Refresh Update Mgr. data\" /></a>$tab$tab<a href=\"../deployLogs/${targ}.html\"><input type=submit class=styled-button-2 value=\"Recent ${targ} Deployments\" /></a>$tab";
...
print "<a href=\"http://cvbuild.cv.infra:7001/job/Auto_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Restart a tcserver instance\" /></a>
$resetState
</td></tr>\n";
