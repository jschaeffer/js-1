...
$perf_components = array
   ...
   array("Dynamic-Ad-Insertion-cm","$tab;Campaign Mgr","DAI-CampaignMgmt-PackageDeploy-5.9.0","1","9600/Dynamic-Ad-Insertion-cm/login/auth"),
   ...
   array("dai-etl-feeder","ETL Feeder","dai-etl-feeder-PackageDeploy-4.0.0.1","NA","NA"),
   array("MicroDev","$tab;MicroStrategy","MicroStrategy-PackageDeploy-4.0.0","NA","NA"),
   array("smsi_reporting","SMSI Reporting","smsi_reporting-PackageDeploy-5.0.0","NA","NA"),
   ...
   array("impression_collector","Impression Collector","impression_collector-PackageDeploy-4.0.0","","NA","NA"),
...
$lab2lab_components = array
   ...
   array("Dynamic-Ad-Insertion-cm","$tab;Campaign Mgr","DAI-CampaignMgmt-PackageDeploy-5.4.0","1","9600/Dynamic-Ad-Insertion-cm/login/auth"),
   array("dai-cip","$tab;CIP Sender","dai-cip-PackageDeploy-4.0.0","1","NA"),
   array("dai-cip-feedback","$tab;CIP Feedback","dai-cip-feedback-PackageDeploy-4.0.0","1","9300/cip-server"),
   ...
   array("dai-metadata-ingestion","DAI MetaData Ingestion","dai-metadata-ingestion-PackageDeploy-4.0.0","1","NA"),
   array("impression_collector","Impression Collector","impression_collector-PackageDeploy-4.0.0","1","NA","NA")
   );
...
$cox_components = array
   ...
   array("ads-core","ADS Core","ads-core-PackageDeploy-4.0.0","NA","NA","NA"),
   array("Dynamic-Ad-Insertion-engine","$tab;Decision Engine","DAI-DecisionEngine-PackageDeploy-4.0.0","5","9610/ads"),
   array("POIS","POIS","POIS-PackageDeploy-4.0.0","POIS","NA","NA"),
   array("smsi-publisher","SMSI Publisher","smsi-publisher-PackageDeploy-4.0.0","2","9520/smsi-publisher/smsipub"),
   );
...
$grid_envs = array(devint, scrum1, scrum2, scrum3, scrum4, zayo_perf, base, fw, kodiak, coxlab, broadway, production);
$rcr_envs = array(base, fw, kodiak, coxlab, broadway);
$post_envs = array(Marley);
$perf_envs = array(performance);
$zayo_perf_envs = array(zayo_perf);
$lab_envs = array(base,fw,kodiak,broadway);
