...
$components = array
   ...
   array("ops-dce-safi-reporting-agent","$tab;Ops SAFI Agent","ops-dce-safi-reporting-agent-PackageDeploy-1.0.0","dce-agent-002","NA"),
   array("ops-dce-scte-cfa-reporting-agent","$tab;Ops SCTE Agent","ops-dce-scte-cfa-reporting-agent-PackageDeploy-1.0.0","dce-agent-001","NA"),
   array("metadata-publisher","$tab;MetaData Publisher","metadata-publisher_PackageDeploy-4.0.0","metadata-publisher","NA"),
   array("dai-dce","$tab;DAI DCE","dai-dce_PackageDeploy-4.0.0","dai-dce","NA"),
   ...
   array("dai-national-cis","NCIS","DAI-national-cis-PackageDeploy-4.0.0","dai-national-cis","9575/nCisClient/"),
   array("dai-metadata-ingestion","DAI MetaData Ingestion","dai-metadata-ingestion-PackageDeploy-4.0.0","NA","NA"),
   array("Pgmr-Cpgn-Int","PCI","Pgmr-Cpgn-Int-PackageDeploy-4.0.0","Pgmr-Cpgn-Int","NA"),
   array("ops-dt-domain","Ops DT Domain DB","ops-dt-domain-PackageDeploy-1.0.0","NA","NA"),
   array("ops-dce-metadata-agent","Ops DCE Mdata Agent","ops-dce-metadata-agent-PackageDeploy-1.0.0","dce-mdata","NA"),
   array("int-test-support","Mock Server","int-test-support-PackageDeploy-1.0.0","mock_svr","NA"),
...
$lab2lab_components = array
   ...
   array("caas-admin","$tab;CAAS Admin","caas-admin-PackageDeploy-4.0.0","1","9475/caas-admin/login/auth"),
   array("acp","$tab;Asset CIP Publisher","acp-PackageDeploy-4.0.0","NA","NA"),
   array("Pgmr-Cpgn-Int","$tab;Programmers Campaign Interface","Pgmr-Cpgn-Int-PackageDeploy-4.0.0","1","NA"),
...
$grid_envs = array(devint, scrum1, scrum2, scrum3, scrum4, Marley, performance, base, fw, kodiak, coxlab, prodtest);
