...
print "</tr>\n";
print "<table width=1200px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=${back_col} colspan=7 align=left>Operations --> $tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/zayo_perf-EnvRefresh/build?token=TOKEN_NAME\"><input type=submit class=styled-button-2 value=\"Refresh data\" /></a>$tab$tab<a href=\"../deployLogs/zayo_perf.html\"><input type=submit class=styled-button-2 value=\"Recent ${targ} Deployments\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/Zayo_perf_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Update a Component\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/${targ}_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Restart a tcserver instance\" /></a>
</td></tr>\n";
print "<tr bgcolor=${back_col}>\n";
