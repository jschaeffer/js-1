...
print "</tr>\n";
print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=${back_col} colspan=7 align=left><a href=\"http://cvbuild.cv.infra:7001/job/SelectSCMEnv-Refresh/buildWithParameters?token=TOKEN_NAME&SelEnv=${targ}\"><input type=submit class=styled-button-2 value=\"Refresh Update Mgr. data\" /></a>$tab
$tab<a href=\"../deployLogs/${targ}.html\"><input type=submit class=styled-button-2 value=\"Recent ${targ} Deployments\" /></a>
$tab
<a href=\"http://cvbuild.cv.infra:7001/job/${targ}_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Deploy a Component\" /></a>
$tab
<a href=\"http://cvbuild.cv.infra:7001/job/${targ}_Multicomponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Deploy Multiple Components at DevInt Version\" /></a>
$tab
<a href=\"http://cvbuild.cv.infra:7001/job/Auto_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Restart a tcserver instance\" /></a>
</td></tr>\n";
...
print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=${back_col} colspan=6 align=left>Operations --> $tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/SelectSCMEnv-Refresh/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Refresh data\" /></a>$tab$tab<a href=\"../deployLogs/${targ}.html\"><input type=submit class=styled-button-2 value=\"Recent ${targ} Deployments\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/${targ}_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Update a Component\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/${targ}_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Restart a tcserver instance\" /></a>
</td></tr>\n";
...
print "</tr>\n";
print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=${back_col} colspan=7 align=left>Operations --> $tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/performance-EnvRefresh/build?token=TOKEN_NAME\"><input type=submit class=styled-button-2 value=\"Refresh data\" /></a>$tab$tab<a href=\"../deployLogs/${targ}.html\"><input type=submit class=styled-button-2 value=\"Recent ${targ} Deployments\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/${targ}_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Update a Component\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/${targ}_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Restart a tcserver instance\" /></a>
</td></tr>\n";
print "<tr bgcolor=${back_col}>\n";
print "<td width=25%><b><u>Component</b></u></td>\n";
...
print "</tr>\n";
print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=${back_col} colspan=7 align=left>Operations --> $tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/zayo-perf-EnvRefresh/build?token=TOKEN_NAME\"><input type=submit class=styled-button-2 value=\"Refresh data\" /></a>$tab$tab<a href=\"../deployLogs/${targ}.html\"><input type=submit class=styled-button-2 value=\"Recent ${targ} Deployments\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/${targ}_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Update a Component\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/${targ}_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Restart a tcserver instance\" /></a>
</td></tr>\n";
print "<tr bgcolor=${back_col}>\n";
print "<td width=25%><b><u>Component</b></u></td>\n";
print "<td width=15%><b><u>Current ${dashtarg} Version</u><br>& Date Installed<br>& JDK Used</b></td>\n";
...
global $cmdev;
  for ($x=0; $x<$zayo_perf_arrlength; $x++) {
     ...
     echo "$upbuton";
     $recentchg = "<h2><a href=\"http://cvbuild.cv.infra:7001/job/".$zayo_perf_components[$x][2]."/changes\">See Version Info</a></h3>";
     print "</td><td class=dash>";
     echo "$recentchg";
     print "</td>";
...
print "<a href=\"../deployLogs/lab2lab.html\"><input type=submit class=styled-button-2 value=\"Recent Lab-to-Lab Deployments\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/lab2lab_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Update a Component\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/view/lab-2-lab/job/lab-2-lab_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Restart a tcserver instance\" /></a>
</td></tr>\n";
...
print "<a href=\"../deployLogs/coxlab.html\"><input type=submit class=styled-button-2 value=\"Recent Cox Lab Deployments\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/cox_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Update a Component\" /></a></td></tr>\n";
