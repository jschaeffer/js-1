...
<td>Dynamic-Ad-Insertion<br><a href="http://10.13.18.115:9610/ads"><?php echo "ads-" . shell_exec("ssh tcserver@dvappdai02 grep Implementation-Version /opt/tcserver/instances/ads/webapps/ads/META-INF/MANIFEST.MF | cut -d : -f 2 | tr -d ' '  | tr -d '\r'"); ?></a><br><a href="http://10.13.18.115:9620/ads"><?php echo "psn-" . shell_exec("ssh tcserver@dvappdai02 grep Implementation-Version /opt/tcserver/instances/psn/webapps/ads/META-INF/MANIFEST.MF | cut -d : -f 2 | tr -d ' '  | tr -d '\r'"); ?></a><br>
<a href="http://10.13.18.115:9630/cis"><?php echo "cis-" . shell_exec("ssh tcserver@dvappdai02 grep Implementation-Version /opt/tcserver/instances/ads/webapps/ads/META-INF/MANIFEST.MF | cut -d : -f 2 | tr -d ' '  | tr -d '\r'"); ?></a><br>*<a href=http://10.13.18.168:7001/view/DAI-DecEng/job/DAI-DecisionEngine-PackageDeploy-4.0.0/changes>(Recent Changes)</a><br>
</td>

<td>Dynamic-Ad-Insertion<br><a href="http://10.13.18.116:9610/ads"><?php echo "ads-" . shell_exec("ssh tcserver@dvappdai03 grep Implementation-Version /opt/tcserver/instances/ads/webapps/ads/META-INF/MANIFEST.MF | cut -d : -f 2 | tr -d ' '  | tr -d '\r'"); ?></a><br><a href="http://10.13.18.116:9620/ads"><?php echo "psn-" . shell_exec("ssh tcserver@dvappdai03 grep Implementation-Version /opt/tcserver/instances/psn/webapps/ads/META-INF/MANIFEST.MF | cut -d : -f 2 | tr -d ' '  | tr -d '\r'"); ?></a><br>
<a href="http://10.13.18.116:9630/cis"><?php echo "cis-" . shell_exec("ssh tcserver@dvappdai03 grep Implementation-Version /opt/tcserver/instances/ads/webapps/ads/META-INF/MANIFEST.MF | cut -d : -f 2 | tr -d ' '  | tr -d '\r'"); ?></a><br>*<a href=http://10.13.18.168:7001/view/DAI-DecEng/job/DAI-DecisionEngine-Pa
ckageDeploy-4.0.0/changes>(Recent Changes)</a><br>
</td>

<td>Dynamic-Ad-Insertion<br><a href="http://10.13.18.117:9610/ads"><?php echo "ads-" . shell_exec("ssh tcserver@dvappdai04 grep Implementation-Version /opt/tcserver/instances/ads/webapps/ads/META-INF/MANIFEST.MF | cut -d : -f 2 | tr -d ' '  | tr -d '\r'"); ?></a><br><a href="http://10.13.18.117:9620/ads"><?php echo "psn-" . shell_exec("ssh tcserver@dvappdai04 grep Implementation-Version /opt/tcserver/instances/psn/webapps/ads/META-INF/MANIFEST.MF | cut -d : -f 2 | tr -d ' '  | tr -d '\r'"); ?></a><br>
<a href="http://10.13.18.117:9630/cis"><?php echo "cis-" . shell_exec("ssh tcserver@dvappdai04 grep Implementation-Version /opt/tcserver/instances/ads/webapps/ads/META-INF/MANIFEST.MF | cut -d : -f 2 | tr -d ' '  | tr -d '\r'"); ?></a><br>*<a href=http://10.13.18.168:7001/view/DAI-DecEng/job/DAI-DecisionEngine-Pa
ckageDeploy-4.0.0/changes>(Recent Changes)</a><br>
</td>
