...
print "<h3>DevInt and Scrum Testing Dashboards</h3>";
 for ($e=0; $e<$envlength; $e++) {
  ...
  $dashtarg=strtoupper($targ);
print "<table width=1100px border=0 align=center cellpadding=4 cellspacing=0>\n";
print "<td bgcolor=${back_col} align=left><input class=\"lnk\" id=\"lnk$inclnk\" type=\"button\" value=\"[+] Expand\" onclick=\"toggle_visibility('tbl$inclnk','lnk$inclnk');\"></td><td bgcolor=${back_col} align=left><strong>${dashtarg}</strong></td><td bgcolor=${back_col} align=left>$tab$tab$tab$tab$tab Data Current as of : $lastup $tab$tab$tab </td><td bgcolor=${back_col} align=right>Disk Space Left- $targdisk</td>\n";
print "</tr>\n";
print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=${back_col} colspan=7 align=left><a href=\"http://10.13.18.168:7001/job/SelectSCMEnv-Refresh/buildWithParameters?token=TOKEN_NAME&SelEnv=${targ}\"><input type=submit class=styled-button-2 value=\"Refresh Update Mgr. data\" /></a>$tab
$tab<a href=\"../deployLogs/${targ}.html\"><input type=submit class=styled-button-2 value=\"Recent ${targ} Deployments\" /></a>
$tab
<a href=\"http://10.13.18.168:7001/job/${targ}_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Deploy a Component\" /></a>
$tab
<a href=\"http://10.13.18.168:7001/job/${targ}_Multicomponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Deploy Multiple Components at DevInt Version\" /></a>
$tab
<a href=\"http://10.13.18.168:7001/job/Auto_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Restart a tcserver instance\" /></a>
</td></tr>\n";
print "<tr bgcolor=${back_col}>\n";

print "<td width=15%><b><u>Component</b></u></td>\n";
print "<td width=15%><b><u>Current ${dashtarg} Version/JDK used</b></u></td>\n";
  ...
  for ($x=0; $x<$arrlength; $x++) {
     ...
     $locver=str_replace("_",".","$locver1");
        if ($devver == $locver) {
             ...
             $updavail = "<a href=\"http://10.13.18.168:7001/job/${targ}_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-3 value=\"Yes Update\" /></a> -to $cmdev";
        }
     ...
     $envstate="$targ/".$components[$x][3].".envstate.txt";
     include "$envstate";
     print "</td><td class=dash align=center>";
     ...
     if ($myposup == true) {
       ...
       if ($webinf == "NA") {
           ...
           $resurl="<a href=http://10.13.18.168:7001/job/Auto_RestartTcserver/buildWithParameters?token=TOKEN_NAME&DeployTarg=${targ}&Instance=".$components[$x][0]."><input type=submit class=styled-button-3 value=\"Restart\" /></a>";
//           $resurl="<a href=http://10.13.18.168:7001/job/${targ}_RestartTcserver/buildWithParameters?token=TOKEN_NAME&Instance=".$components[$x][0]."/><input type=submit class=styled-button-3 value=\"Restart\" /></a>";
       }
       print "$resurl";
     } else {
     }
...
foreach ($zayo_perf_envs as $targ) {
  $targdisk=file_get_contents("${targ}/diskspace.txt", true);
  $inclnk++;
  $lastup=file_get_contents("$targ/dtupd.txt", true);
  $dashtarg=strtoupper($targ);
...
print "</tr>\n";
print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=${back_col} colspan=7 align=left>Operations --> $tab$tab<a href=\"http://10.13.18.168:7001/job/zayo-perf-EnvRefresh/build?token=TOKEN_NAME\"><input type=submit class=styled-button-2 value=\"Refresh data\" /></a>$tab$tab<a href=\"../deployLogs/${targ}.html\"><input type=submit class=styled-button-2 value=\"Recent ${targ} Deployments\" /></a>$tab$tab<a href=\"http://10.13.18.168:7001/job/${targ}_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Update a Component\" /></a>$tab$tab<a href=\"http://10.13.18.168:7001/job/${targ}_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Restart a tcserver instance\" /></a>
</td></tr>\n";
print "<tr bgcolor=${back_col}>\n";
print "<td width=25%><b><u>Component</b></u></td>\n";
print "<td width=15%><b><u>Current ${dashtarg} Version</u><br>& Date Installed<br>& JDK Used</b></td>\n";
print "<td width=15%><b><u>Newer Available?</b></u></td>\n";
print "<td width=15% align=center><b><u>Version Description</b></u></td>\n";
print "<td width=12% align=center><b><u>Host/Instance</b></u></td>\n";
print "<td width=4% align=center><b><u>tcServer State</b></u>\n";
print "<td width=4% align=center><b><u>Log Usage</b></u></td>\n";
print "</tr>\n";
global $cmloc;
global $cmdev;
  for ($x=0; $x<$zayo_perf_arrlength; $x++) {
     $comp_dir="${targ}/".$zayo_perf_components[$x][0]."";
     print "<tr>";
     echo "<td class=dash>".$zayo_perf_components[$x][1]."</td><td class=dash>";
     if (file_exists("${comp_dir}.txt")) {
       include "${comp_dir}.txt";
     } else {
       echo "Not Inst.";
     }
     $instdate=file_get_contents("${targ}/".$zayo_perf_components[$x][0].".instdate.txt", true);
     $updavail="<br>$instdate";
     echo "$updavail";
     include "${comp_dir}.JDK.txt";
     print "</td><td class=dash>";
     $cmdev=file_get_contents("devint/".$zayo_perf_components[$x][0].".txt", true);
     $cmloc=file_get_contents("${comp_dir}.txt", true);
     $devver1=str_replace(".","","$cmdev");
     $locver1=str_replace(".","","$cmloc");
     $devver=str_replace("_",".","$devver1");
     ...
     echo "$upbuton";
     $recentchg = "<h2><a href=\"http://10.13.18.168:7001/job/".$zayo_perf_components[$x][2]."/changes\">See Version Info</a></h3>";
     print "</td><td class=dash>";
     echo "$recentchg";
     print "</td>";
     global $zayo_perf_comps;
     $zayo_perf_comps=$zayo_perf_components[$x][3];
        print "<td class=dash align=center>";
     for ($y=0; $y<$zayo_perf_comps; $y++) {
        include "$targ/".$zayo_perf_components[$x][0].$y."_app.txt";
        print "<br>";
     }
        print "</td>";
        print "<td class=dash align=center>";
     for ($y=0; $y<$zayo_perf_comps; $y++) {
        include "$targ/".$zayo_perf_components[$x][0].$y."_envstate.txt";
        print "<br>";
     }
        print "</td>";
        print "<td class=dash align=center>";
     for ($y=0; $y<$zayo_perf_comps; $y++) {
        include "$targ/".$zayo_perf_components[$x][0].$y.".logs";
        print "<br>";
     }
     print "</tr>";
  }
...
foreach ($lab_envs as $targ) {
  ...
  $dashtarg=strtoupper($targ);
print "<table width=1100px border=0 align=center cellpadding=4 cellspacing=0>\n";
print "<td bgcolor=${back_col} align=left><input class=\"lnk\" id=\"lnk$inclnk\" type=\"button\" value=\"[+] Expand\" onclick=\"toggle_visibility('tbl$inclnk','lnk$inclnk');\"></td><td bgcolor=${back_col} align=left width=6%><strong>${dashtarg}</strong></td><td bgcolor=${back_col} align=left>$tab$tab$tab$tab$tab$tab Data Current as of : $lastup $tab$tab$tab </td><td bgcolor=${back_col} align=right>$tab$tab$tab$tab$tab$tab</td>\n";
print "</tr>\n";

print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=${back_col} colspan=7 align=left>Operations --> $tab$tab<a href=\"http://10.13.18.168:7001/job/lab-to-labEnv-Refresh\"><input type=submit class=styled-button-2 value=\"Refresh Update Mgr. data\" /></a>$tab";
print "<a href=\"../deployLogs/lab2lab.html\"><input type=submit class=styled-button-2 value=\"Recent Lab-to-Lab Deployments\" /></a>$tab$tab<a href=\"http://10.13.18.168:7001/job/lab2lab_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Update a Component\" /></a>$tab$tab<a href=\"http://10.13.18.168:7001/view/lab-2-lab/job/lab-2-lab_RestartTcserver/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Restart a tcserver instance\" /></a>
</td></tr>\n";
...
print "<h3>Cox Lab Dashboard</h3>";
foreach ($cox_envs as $targ) {
  $inclnk++;
  $lastup=file_get_contents("coxlab/dtupd.txt", true);
  $dashtarg=strtoupper($targ);
print "<table width=1100px border=0 align=center cellpadding=4 cellspacing=0>\n";
print "<td bgcolor=${back_col} align=left width=14%><input class=\"lnk\" id=\"lnk$inclnk\" type=\"button\" value=\"[+] Expand\" onclick=\"toggle_visibility('tbl$inclnk','lnk$inclnk');\"></td><td bgcolor=${back_col} align=left width=15%><strong>${dashtarg}</strong></td><td bgcolor=${back_col} align=left>Data Current as of : $lastup  </td><td bgcolor=${back_col} align=right></td>\n";
print "</tr>\n";

print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=${back_col} colspan=10 align=left>Operations --> $tab$tab$tab";
print "<a href=\"../deployLogs/coxlab.html\"><input type=submit class=styled-button-2 value=\"Recent Cox Lab Deployments\" /></a>$tab$tab<a href=\"http://10.13.18.168:7001/job/cox_SingleComponent_Deploy/build?delay=0sec\"><input type=submit class=styled-button-2 value=\"Update a Component\" /></a></td></tr>\n";
...
global $cmdev;
  ...
  for ($x=0; $x<$cox_arrlength; $x++) {
     $comp_dir="${targ}/".$cox_components[$x][0]."";
     $cmloc=file_get_contents("${comp_dir}.txt", true);
     print "<tr>";
     echo "<td class=dash>".$cox_components[$x][1]."</td><td class=dash>";
     if (file_exists("${comp_dir}.txt")) {
       include "${comp_dir}.txt";
     } else {
       echo "Not Inst.";
     }
     $instdate=file_get_contents("${targ}/".$cox_components[$x][0].".instdate.txt", true);
     $showinst="<td class=dash>$instdate";
     echo "$showinst";
     print "</td><td class=dash>";
     $rel_dir="releases/".$cox_components[$x][0]."_$cmloc";
     $recentchg = "<h2><a href=\"${rel_dir}.html\">See Version Info</a></h3>";
     echo "$recentchg";
     print "</td></tr>";
  }
...
print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=${back_col} colspan=10 align=left>Operations --> $tab$tab$tab$tab$tab$tab<a href=\"http://10.13.18.168:7001/job/NewProd-env_refresh/build?token=TOKEN_NAME\"><input type=submit class=styled-button-2 value=\"Refresh Update Mgr. data\" /></a>$tab";
