...
print "<td bgcolor=#CEFFFD align=left><input class=\"lnk\" id=\"lnk$inclnk\" type=\"button\" value=\"[+] Open Grid\" onclick=\"toggle_visibility('tbl$inclnk','lnk$inclnk');\"></td><td bgcolor=#CEFFFD align=left><strong>Version Info across all DevInt/Scrum systems</strong></td><td bgcolor=#CEFFFD align=left></td>\n";
print "</tr>\n";
...
print "<table width=1100px border=1 align=center valign=top cellpadding=3 cellspacing=0 id=\"tbl$inclnk\" name=\"tbl$inclnk\" class=\"tbl\">\n";
print "<tr><td bgcolor=#CEFFFD colspan=10 align=left>Operations --> $tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/xxxEnv-Refresh\"><input type=submit class=styled-button-4 value=\"(Will be) Refresh Update Mgr. data\" /></a>$tab";
print "<a href=\"../deployLogs/production.html\"><input type=submit class=styled-button-4 value=\"Recent Production Deployments\" /></a>$tab$tab<a href=\"http://cvbuild.cv.infra:7001/job/Prodtest_SingleComponentDeploy/build?delay=0sec\"><input type=submit class=styled-button-4 value=\"(Will be)Update a Component\" /></a></td></tr>\n";
