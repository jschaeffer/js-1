...
if [[ ${#} != "4" ]]; then
    ...
    echo "Examples:"
    echo "${0} alph_asset_mgr alph_asset_mgr br_1.0.0 build_number"
    echo "${0} Dynamic-Ad-Insertion-cm campaign-management br_1.0.0 build_number"
    exit 1
fi
