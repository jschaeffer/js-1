...
fnMetaTrigger() {
   ...
   cd /opt/build/scripts/zayo_L2L
       ...
       executeCommand "tar xf /opt/build/archives/metadata-sync/${ARCHIVE}"
...
fnRptVer() {
  echo "${VERSION}" > /var/www/html/lab2lab/${Suite}/${Component}.txt
  echo "${VERSION} > /var/www/html/lab2lab/${Suite}/${Component}.txt"
  date | awk '{print $2,$3,$4}' > /var/www/html/lab2lab/${Suite}/${Component}.instdate.txt
}
